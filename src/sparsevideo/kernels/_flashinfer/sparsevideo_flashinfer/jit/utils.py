...
dtype_map = {
    ...
    torch.int32: "int32_t",
    torch.int64: "int64_t",
    **({torch.uint32: "uint32_t"} if hasattr(torch, "uint32") else {}),
    **({torch.uint64: "uint64_t"} if hasattr(torch, "uint64") else {}),
}
...
dtype_cutlass_map = {
    ...
    **({torch.uint32: "cutlass::uint32_t"} if hasattr(torch, "uint32") else {}),
    **({torch.uint64: "cutlass::uint64_t"} if hasattr(torch, "uint64") else {}),
}
...
filename_safe_dtype_map = {
    ...
    torch.int32: "i32",
    torch.int64: "i64",
    **({torch.uint32: "u32"} if hasattr(torch, "uint32") else {}),
    **({torch.uint64: "u64"} if hasattr(torch, "uint64") else {}),
}
