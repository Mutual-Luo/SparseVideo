...
# These are imported by cascade/decode/prefill/sparse at module level
...
from .attention import gen_customize_single_prefill_module as gen_customize_single_prefill_module
from .attention import gen_customize_single_decode_module as gen_customize_single_decode_module
...
# gen_act_and_mul_module is imported by activation.py which is imported by some modules
def gen_act_and_mul_module(*args, **kwargs):
    raise NotImplementedError("activation JIT not available in sparsevideo vendor build")
