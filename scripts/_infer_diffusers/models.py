...
MODEL_SPECS: dict[str, ModelSpec] = {
    ...
    "skyreels-v2-t2v-14b": ModelSpec(
        ...
        hf_id="Skywork/SkyReels-V2-T2V-14B-720P-Diffusers", local_dir="skyreels-v2-t2v-14b-Diffusers",
    ...
    "skyreels-v2-i2v-14b": ModelSpec(
        ...
        hf_id="Skywork/SkyReels-V2-I2V-14B-720P-Diffusers", local_dir="skyreels-v2-i2v-14b-Diffusers",
    ...
    "cogvideox-t2v": ModelSpec(
        ...
        hf_id="THUDM/CogVideoX-5b", local_dir="CogVideoX-5b-Diffusers",
    ...
    "cogvideox-i2v": ModelSpec(
        ...
        hf_id="THUDM/CogVideoX-5b-I2V", local_dir="CogVideoX-5b-I2V-Diffusers",
        fps=8, default_frames=49, default_steps=50, guidance_scale=6.0, output_type="pil",
        sparse_supported=True,
    ),
    "ltx-video": ModelSpec(
        key="ltx-video", pipeline_class="LTXPipeline",
        hf_id="Lightricks/LTX-Video", local_dir="ltx-video-Diffusers",
    ...
    "easyanimate-v5-t2v-12b": ModelSpec(
        ...
        hf_id="alibaba-pai/EasyAnimateV5.1-12b-zh-diffusers", local_dir="easyanimate-v5-t2v-12b-Diffusers",
