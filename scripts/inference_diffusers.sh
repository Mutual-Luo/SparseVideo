...
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffusers.py --model wan22             --method radial     --prompt-file example/t2v/1.txt --cpu-offload --cpu-offload-mode model # 30:27
...
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffusers.py --model hunyuan-i2v       --method draft      --prompt-file example/i2v/1.txt --image example/i2v/1.jpg # 27:14 (needs to balance again)
...
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffusers.py --model skyreels-v2       --method radial     --prompt-file example/t2v/1.txt # 57:12 [needs to recheck later]
...
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffusers.py --model skyreels-v2-i2v   --method radial     --prompt-file example/i2v/1.txt --image example/i2v/1.jpg # 56:53 [needs to recheck later]
...
# ---------------------------------------
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wananimate        --method dense      --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 24:02
CUDA_VISIBLE_DEVICES=4 python scripts/infer_diffusers.py --model wananimate        --method svg1       --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 16:31
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wananimate        --method svg2       --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 19:30
CUDA_VISIBLE_DEVICES=6 python scripts/infer_diffusers.py --model wananimate        --method spargeattn --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 18:13
CUDA_VISIBLE_DEVICES=7 python scripts/infer_diffusers.py --model wananimate        --method radial     --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 16:11
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wananimate        --method sta        --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wananimate        --method draft      --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 14"55
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wananimate        --method adacluster --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 15:34
CUDA_VISIBLE_DEVICES=6 python scripts/infer_diffusers.py --model wananimate        --method flashomni  --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 19:05
CUDA_VISIBLE_DEVICES=7 python scripts/infer_diffusers.py --model wananimate        --method svoo       --prompt-file example/animate/1.txt --image example/animate/process_results/src_ref.png --pose-video example/animate/process_results/src_pose.mp4 --face-video example/animate/process_results/src_face.mp4 --cpu-offload --cpu-offload-mode model # 17:44

# ---------------------------------------
# wan vace 1.3b (model: wan-vace)
# ---------------------------------------
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan-vace          --method dense      --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 18:10
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan-vace          --method svg1       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 13:27
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan-vace          --method svg2       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 12:35
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffusers.py --model wan-vace          --method spargeattn --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 13:44
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffusers.py --model wan-vace          --method radial     --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 12:59
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wan-vace          --method sta        --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan-vace          --method draft      --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 12:05
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan-vace          --method adacluster --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 12:03
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffusers.py --model wan-vace          --method flashomni  --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 12:43
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffusers.py --model wan-vace          --method svoo       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 11:15

# ---------------------------------------
# wan vace 14b (model: wan21-vace-14b)
# ---------------------------------------
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan21-vace-14b    --method dense      --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 72:02
CUDA_VISIBLE_DEVICES=4 python scripts/infer_diffusers.py --model wan21-vace-14b    --method svg1       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 47:51
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wan21-vace-14b    --method svg2       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 52:54
CUDA_VISIBLE_DEVICES=6 python scripts/infer_diffusers.py --model wan21-vace-14b    --method spargeattn --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 52:09
CUDA_VISIBLE_DEVICES=7 python scripts/infer_diffusers.py --model wan21-vace-14b    --method radial     --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 47:38
CUDA_VISIBLE_DEVICES=5 python scripts/infer_diffusers.py --model wan21-vace-14b    --method sta        --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffusers.py --model wan21-vace-14b    --method draft      --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 44:00
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffusers.py --model wan21-vace-14b    --method adacluster --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 44:24
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffusers.py --model wan21-vace-14b    --method flashomni  --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 52:44
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffusers.py --model wan21-vace-14b    --method svoo       --prompt-file example/inpainting/prompt.txt --reference-video example/inpainting/src_video.mp4 --mask-video example/inpainting/src_mask.mp4 --height 720 --width 1280 --num-frames 81 # 50:41
