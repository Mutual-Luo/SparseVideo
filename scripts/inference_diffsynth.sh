...
# ── wan22-t2v-a14b ───────────────────────────────────────────────────────────
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method dense      --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method svg1       --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method svg2       --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method spargeattn --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method radial     --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method sta        --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method draft      --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method adacluster --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method flashomni  --prompt-file example/t2v/1.txt
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-t2v-a14b --method svoo       --prompt-file example/t2v/1.txt
...
# ── wan22-i2v-a14b ───────────────────────────────────────────────────────────
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method dense      --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method svg1       --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method svg2       --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method spargeattn --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method radial     --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method sta        --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=2 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method draft      --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=3 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method adacluster --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=0 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method flashomni  --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
CUDA_VISIBLE_DEVICES=1 python scripts/infer_diffsynth.py --model wan22-i2v-a14b --method svoo       --prompt-file example/i2v/1.txt --input-image example/i2v/1.jpg
